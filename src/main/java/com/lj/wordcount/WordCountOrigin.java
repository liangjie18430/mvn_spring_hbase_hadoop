...
public class WordCountOrigin {// 继承泛型类Mapper
	...
	public static void main(String[] args) throws Exception {
		...
		// 为了能够找到WordCountOrigin这个类
		job.setJarByClass(WordCountOrigin.class); // 指定map类型
		job.setMapperClass(TokenizerMapper.class);
		/********
		 * 指定CombinerClass类 这里很多人对CombinerClass不理解
		 */
